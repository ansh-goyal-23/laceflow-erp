...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Shree Lace ERP" },
      { name: "description", content: "ERP for Shree Lace Industries — manufacturer of shoe laces and webbing." },
      { name: "author", content: "Shree Lace Industries" },
      { property: "og:title", content: "Shree Lace ERP" },
      { property: "og:description", content: "ERP for Shree Lace Industries — manufacturer of shoe laces and webbing." },
