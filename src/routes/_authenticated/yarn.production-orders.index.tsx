                  ...
                  <TableRow key={o.id}>
                    ...
                    <TableCell>
                      <div className="flex items-center gap-1">
                        ...
                        <Button variant="ghost" size="icon" asChild title="Edit full order"><Link to="/yarn/production-orders/$id/edit" params={{ id: o.id }}><Pencil className="h-4 w-4" /></Link></Button>
